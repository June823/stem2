    ...
    return (
        <div className='fixed w-full h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center z-50'>
            <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
                ...
                <form className='grid p-4 gap-3 overflow-y-scroll h-full pb-10' onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        className='p-2 bg-slate-100 border rounded focus:outline-blue-400'
                        required
                    />
                    ...
                    <label htmlFor='uploadImageInput'>
                        <div className='p-2 bg-slate-100 border rounded h-32 w-full flex justify-center items-center cursor-pointer border-dashed border-slate-400'>
                    ...
                    <textarea
                        className='h-28 bg-slate-100 border resize-none p-2 rounded focus:outline-blue-400'
