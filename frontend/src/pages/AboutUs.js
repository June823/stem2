    ...
    <div className='container mx-auto p-4 pt-24 min-h-[80vh]'>
      <div className='bg-white p-6 md:p-10 shadow-md rounded-md max-w-4xl mx-auto'>
        ...
        <p className='text-slate-600 leading-relaxed mb-4 text-lg'>
          Welcome to vintage fibres, your premier destination for high-quality baskets and apparel. 
          Founded by Rodgers Oyugi, a graduate of Agriculture with a strong passion for sustainable farming, food security, and agribusiness innovation. 
    This platform was built to bridge the gap between 
        ...
        <div className='grid md:grid-cols-2 gap-6 mt-8'>
            ...
            <div className='border-l-4 border-red-600 pl-4'>
                ...
                <p className='text-slate-500'>To become the leading e-commerce site in East Africa.</p>
            </div>
        </div>
      </div>
    </div>
